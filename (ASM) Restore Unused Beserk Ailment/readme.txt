...
This patch fixes being able to apply the ailment on allies, and provides a few aesthetic fixes in the ASM.

It works only on allies (for now). If applied to a monster, the monster always misses.
